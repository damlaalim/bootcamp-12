...
{
    public Vector3 leftPosition = new Vector3(2.3927536f, 26.1755829f, 44.4430923f);
    public Vector3 rightPosition = new Vector3(-28.8164616f, 7.12477493f, 27.9515495f);
